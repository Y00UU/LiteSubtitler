...
class Ui_dlgSetting(object):
    def setupUi(self, dlgSetting):
        ...
        self.hlytTranslate.setStretch(4, 1)
        self.hlytTranslate.setStretch(6, 2)
    ...
    def retranslateUi(self, dlgSetting):
        ...
        self.lblWhisperExe.setText(_translate("dlgSetting", "FasterWhisper工具"))
        ...
        self.ckbHumanVoice.setText(_translate("dlgSetting", "消除背景音乐"))
